  ...
  return (
    ...
    >
      <div className="landing-container">
        ...
        <div className="flex flex-col gap-2 sm:gap-5 max-w-4xl mx-auto px-0">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-2 sm:gap-4 items-stretch justify-items-center">
