...
export function ValueStrip() {
  return (
    <section className="py-8 sm:py-10 bg-muted/30 border-y border-border/40 w-full max-w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-full box-border">
        <p className="text-center text-sm font-medium text-muted-foreground mb-6 max-w-2xl mx-auto">
