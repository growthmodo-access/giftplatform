    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 p-8 text-white shadow-2xl">
        <div className="relative z-10">
          ...
          <p className="text-purple-100 text-lg">Here's what's happening with your gift platform today.</p>
        </div>
        <div className="absolute top-0 right-0 -mt-4 -mr-4 w-64 h-64 bg-white/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 -mb-8 -ml-8 w-48 h-48 bg-white/5 rounded-full blur-2xl"></div>
      </div>
